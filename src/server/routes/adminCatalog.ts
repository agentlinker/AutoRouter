  ...
  return {
    ...
    instances: details.instances.map((instance) => {
      ...
      return {
        ...
        runtime_status: instance.model.runtimeStatus ?? "normal",
        status_reason: instance.model.statusReason ?? null,
        status_message: instance.model.statusMessage ?? null,
        status_source: instance.model.statusSource ?? "system",
        status_updated_at: instance.model.statusUpdatedAt ?? null,
        status_cooldown_until: instance.model.statusCooldownUntil ?? null,
        rate_limit_strike: instance.model.rateLimitStrike ?? 0,
        recent_error_count: instance.model.recentErrorCount ?? 0,
        provider_runtime_status: instance.provider.runtimeStatus ?? "normal",
        provider_status_reason: instance.provider.statusReason ?? null,
        provider_status_message: instance.provider.statusMessage ?? null,
